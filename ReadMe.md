...
| **Data Science** | Modelado analítico y machine learning para la extracción de insights y la alimentación de sistemas inteligentes. | Power Automate, Apache AirFlow, Pandas, NumPy, Scikit-learn, XGBoost, Random Forest, TensorFlow, Matplotlib, Plotly, Power BI,  SQL. |
